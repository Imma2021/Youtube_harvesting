...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBqs4r27BB_GWA3SkfrTf6hAzrkyaTAiw8"
...
#Village Birds cartoon tamil         :"UCWvWAWrrkmmLsHix20bF21A"
#Chutty Kannamma                     :"UC7ekJbGft4swD_3fb7MiRPw"
#Tamil Stories World                 :"UCE7Hs4N_rWKgog--KpiZ-xQ"
#Choti Birds Tv                      :"UCjzw7vl5TCnFQ55HzqGC2gw"
#Animal HT                           :"UCqVXYi_LeGx2-eqH0G6wqaQ"
#Best Birds Stories-Tamil            :"UCDVHoXxdnu_yG-dXtVtzn5A"
#Jugnu Kids-Tamil                    :"UCz5nQQawgROxwS7v-6hS2WQ"
#Lellobee city Farm                  :"UCqbLFYZfANp88Rn-dIN_Dsg"
#CVS 3D Rhymes                       :"UCsPF3cApzCohxPp5oKdoWSQ"
#Tuni cartoon Stories                :"UCxykHW0NMxJenOB_66is8Dw"
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://Immaculate:immaculate@cluster0.wctkg8d.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
...
st.title(":orange[My Babies Youtube Channel]")

channel_id = st.text_input("Enter the Channel id")
channels = channel_id.split(',')
channels = [ch.strip() for ch in channels if ch]

if st.button("Collect Data and Store"):
...
show_table = st.radio("SELECT THE TABLES FOR VIEW",(":blue[channels]",":blue[playlists]",":blue[videos]",":blue[comments]"))
